...
core_builder_parts = {
    ...
    'trace_stall_min_occ': '.trace_stall_min_occ({trace_stall_min_occ})',
    'trace_stall_rob': '.trace_stall_rob({trace_stall_rob})',
    'trace_stall_depth': '.trace_stall_depth({trace_stall_depth})',
    'trace_store': '.trace_store({trace_store})',
    ...
    'trace_walk_wait': '.trace_walk_wait({trace_walk_wait})',
    'trace_walk_l1i': '.trace_walk_l1i({trace_walk_l1i})',
    'trace_walk_wait_cap': '.trace_walk_wait_cap({trace_walk_wait_cap})',
    'trace_stall_l1i_gate': '.trace_stall_l1i_gate({trace_stall_l1i_gate})',
    'trace_store_cost_evict': '.trace_store_cost_evict({trace_store_cost_evict})',
    'trace_head_uops': '.trace_head_uops({trace_head_uops})',
    'trace_tail_targets': '.trace_tail_targets({trace_tail_targets})',
    'trace_uop_buffer': '.trace_uop_buffer({trace_uop_buffer})',
    'trace_meta_windows': '.trace_meta_windows({trace_meta_windows})',
    'trace_probe_ahead': '.trace_probe_ahead({trace_probe_ahead})',
    'trace_walk_filter': '.trace_walk_filter({trace_walk_filter})',
    'trace_ucp': '.trace_ucp({trace_ucp})',
    'trace_ucp_threshold': '.trace_ucp_threshold({trace_ucp_threshold})',
    'trace_ucp_max_ip': '.trace_ucp_max_ip({trace_ucp_max_ip})',
    'trace_ucp_step': '.trace_ucp_step({trace_ucp_step})',
    'trace_ucp_altind': '.trace_ucp_altind({trace_ucp_altind})',
    'trace_walk_issue_cap': '.trace_walk_issue_cap({trace_walk_issue_cap})',
    'trace_walk_decode_cap': '.trace_walk_decode_cap({trace_walk_decode_cap})',
    'trace_walk_decode_shared': '.trace_walk_decode_shared({trace_walk_decode_shared})',
