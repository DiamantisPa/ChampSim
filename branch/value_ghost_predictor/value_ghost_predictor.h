...
static constexpr unsigned CONF_THRESHOLD    = 1;       // require confidence >= 2 to override
static constexpr unsigned MIN_SAMPLES       = 100;      // require at least N samples to enable ghost
static constexpr float    MISRATE_THRESHOLD = 0.3f;   // ghost candidate when regular misrate > 15%
